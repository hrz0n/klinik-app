  ...
  <main class="main">
           ...
           <div class="col-lg-12">
             <div class="card">
               <div class="card-header text-primary">
                 <b><i class="cil-diamond"></i> <?= $title ?></b>
               </div>
               <div class="card-body">
                 <div class="d-flex flex-wrap justify-content-between mb-1">
                    <div class="col-md-6">
                      ...
                      <button type="button" onclick="add_new()" id="adddata"  class="ml-1 float-left btn-icon btn-pill btn btn-warning"><i class="icon icon-paper-plane"></i> Tambah Jenis Layanan</button>
                      ...
                      <div class="col-md-4">
                        <div class="input-group">
                          ...
                          <input placeholder="Cari Nama Jenis layanan ..." type="text" class="btn-outline-2x form-control global_filter" id="global_filter">
                        </div>
                      </div>
                  </div>
                 ...
                 <table style="width:100%" id="tabelAuthor" class="table table-bordered table-responsive table-sm  table-hover">
                   <thead class="bg-light" >
                     <tr><th style="padding-left:15px;max-width:10px"> <input name="select_all" value="1" id="altet-select-all" type="checkbox" /></th>
                       <th class="pl-2" style="width:400px">Jenis Pelayanan</th>
                       <th class="pl-2" style="width:1000px">Kategori</th>
                       <th class="pl-2" style="width:310px">Created At</th>
                       <th class="pl-2" style="width:310px">Updated At</th>
           ...
           <form action="#" id="form" class="form-horizontal">
             ...
             <div class="form-body">
               <div class="form-group form-group-sm row">
                 <label for="namajenislayanan" class="col-sm-3 col-form-label">Jenis Layanan</label>
                 <div class="col-sm-9">
                   <input required placeholder="Nama Jenis Pelayanan" id="namajenislayanan" class="btn-outline-2x rounded-0 form-control" type="text" name="namajenislayanan" value="">
                   <span class="help-block"></span>
                 </div>
               </div>

               <div class="form-group form-group-sm row" style="margin-top:-12px;" >
                 <label for="namakategori" class="col-sm-3 col-form-label">Kategori</label>
                 <div class="col-sm-9">
                   <select data-placeholder="Pilih kategori" class="form-control" name="namakategori" id="namakategori" required>
                     <option value=""></option>
                     <?php
   ...
   <script type="text/javascript" src="js/jenis.js"></script>
<?php
  require('footer.php');
 ?>
