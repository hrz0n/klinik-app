  ...
  $title = ' Daftar Kategori Pelayanan';
               ...
               <div class="card-body">
                 <div class="d-flex flex-wrap justify-content-between mb-1">
                    <div class="col-md-6">
                      ...
                      <button type="button" onclick="add_new()" id="adddata"  class="ml-1 float-left btn-icon btn-pill btn btn-warning"><i class="icon icon-paper-plane"></i> Tambah Kategori</button>
                      ...
                      <div class="col-md-4">
                        <div class="input-group">
                          ...
                          <input placeholder="Cari Nama kategori pelayanan ..." type="text" class="btn-outline-2x form-control global_filter" id="global_filter">
                        </div>
                      </div>
                  </div>
                 ...
                 <table style="width:100%" id="tabelAuthor" class="table table-bordered table-responsive table-sm  table-hover">
                   <thead class="bg-light" >
                     <tr><th style="padding-left:15px;max-width:10px"> <input name="select_all" value="1" id="altet-select-all" type="checkbox" /></th>
                       <th class="pl-2" style="width:1000px">Nama Kategori Pelayanan</th>
           ...
           <form action="#" id="form" class="form-horizontal">
             ...
             <div class="form-body">
               <div class="form-group form-group-sm row">
                 ...
                 <div class="col-sm-9">
                   <input required placeholder="Nama kategori Pelayanan" id="namakategori" class="btn-outline-2x rounded-0 form-control" type="text" name="namakategori" value="">
